...
<style>.iso-docs-head p,.iso-doc-suggestions strong,.iso-doc-suggestions li,.iso-doc-title,.iso-doc-description,.iso-doc-empty{font-size:13px}.iso-doc-meta,.iso-doc-btn,.iso-doc-submit{font-size:12px}.iso-doc-box>summary{font-size:14px}.iso-doc-form input,.iso-doc-form textarea{font-size:13px}.iso-doc-columns{grid-template-columns:minmax(0,1fr)}.iso-doc-box-client{order:1}.iso-doc-box-template{order:2}</style>
@endonce
