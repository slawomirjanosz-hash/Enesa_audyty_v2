...
<section id="aw-schedule" class="aw-pane">
    ...
    <div class="card"><h2>Interaktywny wykres Gantta</h2>
        <div class="gantt-toolbar">
            ...
            <a class="tool-btn" style="text-decoration:none" href="{{route('audits.gantt.export',$audit)}}"><i class="ti ti-file-spreadsheet"></i> Eksport Excel</a>
