            ...
            <tr>
                <td align="center">
                    <div class="container">
                        ...
                        <div class="content">
                            <h1>Twoje konto zostało zaakceptowane, możesz się teraz zalogować</h1>
                            <p>Miło nam poinformować, że konto dla firmy <strong>{{ $company->name }}</strong> zostało aktywowane.</p>
                            <div class="box">
                                ...
                                <p style="margin-bottom:0;"><strong>Status:</strong> Aktywny</p>
                            </div>
                            <p>
