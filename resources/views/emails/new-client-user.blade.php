...
<head>
    ...
    <title>ENESA - Dostęp do systemu</title>
    <style>
        ...
        .secret { font-size: 20px; letter-spacing: .06em; font-weight: bold; color: #1A4D3A; }
            ...
            <tr>
                <td align="center">
                    <div class="container">
                        ...
                        <div class="content">
                            <h1>Zostałeś dodany do systemu ENESA</h1>
                            <p>Otrzymałeś dostęp do systemu dla firmy <strong>{{ $company->name }}</strong>.</p>
                            <div class="box">
                                <p style="margin-bottom:8px;"><strong>Imię i nazwisko:</strong> {{ $user->name }}</p>
                                <p style="margin-bottom:8px;"><strong>Email:</strong> {{ $user->email }}</p>
                                <p style="margin-bottom:8px;"><strong>Hasło tymczasowe:</strong></p>
                                <div class="secret">{{ $temporaryPassword }}</div>
                            </div>
                            <p>
                                <a href="{{ route('login') }}" class="btn">Przejdź do logowania</a>
                            </p>
                        </div>
