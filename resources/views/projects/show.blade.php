...
function syncRequirementSelection() {
    ...
    if (requirementSelectAll) {
        requirementSelectAll.checked = requirementChecks.length > 0 && selected === requirementChecks.length;
        requirementSelectAll.indeterminate = selected > 0 && selected < requirementChecks.length;
    }
}
...
requirementSelectAll?.addEventListener('change', event => {
    requirementChecks.forEach(checkbox => checkbox.checked = event.currentTarget.checked);
