...
async function saveProjectStatus(select) {
    ...
    try {
        ...
        if (select.dataset.kind === 'finance') {
            ...
            select.classList.remove('requested','ordered','in_progress','purchased','cancelled');
