...
<head>
    ...
    <title>@yield('title', $brandName) — Strefa Klienta</title>
...
<aside id="sidebar">
    ...
    <nav class="sidebar-nav" data-client-standard-menu>
        <ul>
            ...
            <li class="nav-item"><a href="{{ route('client.cylinders.index') }}" class="nav-link {{ request()->routeIs('client.cylinders.*') ? 'active' : '' }}"><i class="ti ti-clipboard-check"></i> Inspektor UDT</a></li>
            @endif
    ...
    let _sessionCheckInterval = setInterval(function () {
        fetch('/session-check', {
            ...
            if (!data.authenticated && !_sessionExpired) {
                ...
                document.title = '\u26A0 Sesja wygasła — {{ $brandName }}';
            }
    ...
    <div id="chat-bubble">
        ...
        <div id="bubble-header">
            <div style="display:flex;align-items:center;gap:8px;">
                ...
                <div>
                    <div style="font-family:'Manrope',sans-serif;font-size:13px;font-weight:700;color:#fff;">Chat {{ $brandName }}</div>
