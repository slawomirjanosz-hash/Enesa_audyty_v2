...
class OfferController extends Controller
{
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        $offer = Offer::create([
            ...
            'content_subject' => $this->offerContent->cleanHtml($data['content_subject'] ?? null),
            'content_scope' => $this->offerContent->cleanHtml($data['content_scope'] ?? null),
            'content_deadline' => $this->offerContent->cleanHtml($data['content_deadline'] ?? null),
            'content_payment' => $this->offerContent->cleanHtml($data['content_payment'] ?? null),
