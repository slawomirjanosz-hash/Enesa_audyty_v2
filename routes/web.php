...
use App\Http\Controllers\IsoDocumentCopyController;
...
Route::prefix('cylinders')->name('cylinders.')->middleware(['auth', 'staff.role', 'app.module:cylinders'])->group(function () {
    ...
    Route::post('/{cylinder}/inspections', [CylinderController::class, 'storeInspection'])->middleware('app.permission:cylinders.manage')->name('inspections.store');
});
...
Route::prefix('client')->name('client.')->middleware(['auth', 'client.role', 'app.module:client_zone'])->group(function () {
    ...
    Route::post('/audits/{audit}/iso-documents/{document}/copy', [IsoDocumentCopyController::class, 'store'])->middleware('app.module:audits')->name('audits.iso-documents.copy');
...
Route::middleware(['auth', 'staff.role'])->group(function () {
    ...
    Route::prefix('audits')->name('audits.')->middleware(['app.module:audits', 'app.permission:audits.view'])->group(function () {
        ...
        Route::delete('/{audit}/tasks/bulk', [AuditController::class, 'bulkDestroyTasks'])->middleware('app.permission:audits.manage,audits.schedule.manage')->name('tasks.bulk-destroy');
